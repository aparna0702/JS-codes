...
// console.log(multiplyBy5.prototype); //This shows everything in JS is a function
 
function createUser(userName, score){
    this.userName = userName 
    this.score = score
}
// We can inject anything in the obj using prototype
...
// but to access it we need to use new keyword
...
it has access to properties and methods defined on the 
...
created object. If no explicit return value is specified from the 
